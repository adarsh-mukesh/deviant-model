...
[thal_sp, thal_l4(:,:,1), sp_l4(:,:,1)]=weight_gen(sp,n1,n2);
...
for t=1:tSim/dt-1
    for i=1:sp
        sp_stim=0;
        for j=1:2*n1+1
            sp_stim=sp_stim+inject(i+j-1,t)*thal_sp(i,i+j-1);
        end
        [a,b]=sb_int_n_fire_sp(sp_stim,sp_volt(i,t));
        sp_volt(i,t+1)=b;
        if a==1
            count3=5;
            sp_fire(i,k_sp(i))=t;
...
%         end
%         [a,b]=sb_int_n_fire_l4(l4_stim,l4_volt(i,t));
%         l4_volt(i,t+1)=b;
%         if a==1
%             l4_fire(i,k_l4(i))=t;
%             l4_fire_las(i,1)=t;
